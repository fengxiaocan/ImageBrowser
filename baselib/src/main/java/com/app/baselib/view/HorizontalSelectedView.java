...
/**
 * <p>用到的动态方法</p>
 * <p>hsMain.setData(strings);//设置数据源</p>
 * <p>hsMain.setAnLeftOffset();//向左移动一个单元</p>
 * <p>hsMain.setAnRightOffset();//向右移动一个单元</p>
 * <p>hsMain.getSelectedString();//获得被选中的文本</p>
 */
...
public class HorizontalSelectedView extends View{
    ...
    private void initAttrs(AttributeSet attrs){
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs,R.styleable.HorizontalSelectedView);
        //两种字体颜色和字体大小
        seeSize = typedArray.getInteger(R.styleable.HorizontalSelectedView_HorizontalSeesize,5);
        selectedTextSize = typedArray.getFloat(R.styleable.HorizontalSelectedView_HorizontalSelectedTextSize,50);
        selectedColor = typedArray.getColor(R.styleable.HorizontalSelectedView_HorizontalSelectedTextColor,context.getResources().getColor(android.R.color.black));
        textSize = typedArray.getFloat(R.styleable.HorizontalSelectedView_HorizontalUnselectedTextSize,40);
        textColor = typedArray.getColor(R.styleable.HorizontalSelectedView_HorizontalUnselectedTextColor,context.getResources().getColor(android.R.color.darker_gray));
    }
