...
public final class RxThread implements Executor {
    ...
    public static Proxy newThread(int size) {
        return Proxy.newThread(size);
    }

    public static Proxy io(int size) {
        return Proxy.io(size);
    }

    public static Proxy scheduled(int size) {
        return Proxy.scheduled(size);
    }
     ...
     * @return
     */
    public <T,V extends View> RxBind<T,V> rxbind(RxBinding<T,V> subscriber) {
        return new RxBind<T,V>(pool,getLocalConfigs()).setSubscriber(subscriber);
    }
    ...
    public static class Proxy {
        ...
        public static Proxy newThread() {
            return new Proxy(10,TYPE_CACHEABLE,null);
        }

        public static Proxy newThread(int size) {
            return new Proxy(size,TYPE_CACHEABLE,null);
        }
        ...
        public static Proxy io() {
            return new Proxy(4,TYPE_FIXED,null);
        }
