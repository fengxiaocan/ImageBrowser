...
class PopupController {
    ...
    /**
     * Instantiates a new Popup controller.
     *
     * @param context
     *         the context
     * @param popupWindow
    ...
    public void dismiss(){
        if(mWindow != null) {
            mWindow.clearFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);//不移除该Flag的话,可能出现黑屏的bug
        }
    }
    ...
    static class PopupParams {
        ...
        /**
         * Instantiates a new Popup params.
         *
         * @param mContext
         *         the m context
         */
