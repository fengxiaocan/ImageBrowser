package com.app.baselib.pathview;
...
public abstract class TextPathView extends PathView {
    ...
    protected void initAttr(Context context,AttributeSet attrs) {
        ...
        mTextSize = typedArray.getDimensionPixelSize(R.styleable.TextPathView_pathTextSize,mTextSize);
        ...
        showPainterActually = typedArray.getBoolean(
                R.styleable.TextPathView_showPainterActually,
                showPainterActually
        );
        mPathStrokeWidth = typedArray.getDimensionPixelOffset(
                R.styleable.TextPathView_pathStrokeWidth,
                mPathStrokeWidth
        );
        mTextStrokeColor = typedArray.getColor(
                R.styleable.TextPathView_pathStrokeColor,
                mTextStrokeColor
        );
        mPaintStrokeWidth = typedArray.getDimensionPixelOffset(
                R.styleable.TextPathView_paintStrokeWidth,
                mPaintStrokeWidth
        );
        mPaintStrokeColor = typedArray.getColor(
                R.styleable.TextPathView_paintStrokeColor,
                mPaintStrokeColor
        );
