...
import com.app.baselib.ui.BasicActivity;
...
public final class ActivityUtils {
     ...
     */
    public static void openActivity(Context context,Class<? extends BasicActivity> clazz) {
    ...
    public static void openActivity(
            Context context,
            Class<? extends BasicActivity> clazz,Bundle bundle
    )
    {
