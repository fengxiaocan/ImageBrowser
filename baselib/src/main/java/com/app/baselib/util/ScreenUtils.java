...
public final class ScreenUtils {
    ...
    public static boolean isLandscape() {
        return Utils.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE;
    }
    ...
    public static boolean isPortrait() {
        return Utils.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
    }
