...
import com.app.baselib.intface.INetStatu;
import com.app.baselib.intface.NetStatuChangeListener;
import com.app.baselib.intface.NetworkType;
...
public final class NetworkUtils {
    ...
    static NetStatuChangeListener sNetStatuChangeListener;
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager)Utils.getContext()
    ...
    public static boolean getWifiEnabled() {
        @SuppressLint("WifiManagerLeak") WifiManager wifiManager = (WifiManager)Utils.getContext()
                                                                                     .getSystemService(
     ...
     * .permission.ACCESS_NETWORK_STATE"/>}</p>
     *
     * @return 网络类型 <ul> <li>{@link NetworkType#NETWORK_WIFI   } </li>
     * <li>{@link NetworkType#NETWORK_4G     } </li> <li>{@link
     * NetworkType#NETWORK_3G     } </li> <li>{@link NetworkType#NETWORK_2G }
     * </li> <li>{@link NetworkType#NETWORK_UNKNOWN} </li> <li>{@link
    ...
    int getNetWorkState() {
        ...
        if (activeNetworkInfo != null && activeNetworkInfo.isConnected()) {
            if (activeNetworkInfo.getType() == (ConnectivityManager.TYPE_WIFI)) {
                return INetStatu.NETWORK_WIFI;
            } else if (activeNetworkInfo.getType() == (ConnectivityManager.TYPE_MOBILE)) {
                return INetStatu.NETWORK_MOBILE;
            }
        } else {
            return NETWORK_NONE;
        }
     ...
     * @param listener
     */
    public static void registerNetStatuChangeListener(
            NetStatuChangeListener listener
    )
    {
        sNetStatuChangeListener = listener;
    }

    /**
     * 注册网络状态监听器
     */
    public static void unregisterNetStatuChangeListener() {
        sNetStatuChangeListener = null;
    }

    public static NetStatuChangeListener getNetStatuChangeListener() {
        return sNetStatuChangeListener;
    }
}