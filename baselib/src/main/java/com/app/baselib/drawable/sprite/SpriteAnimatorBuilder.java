package com.app.baselib.drawable.sprite;
...
public class SpriteAnimatorBuilder {
    ...
    public SpriteAnimatorBuilder translateXPercentage(
            float fractions[],Float... translateXPercentage
    )
    {
    ...
    public SpriteAnimatorBuilder translateYPercentage(
            float[] fractions,Float... translateYPercentage
    )
    {
