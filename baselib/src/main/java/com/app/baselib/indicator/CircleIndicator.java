...
public class CircleIndicator extends View {
	...
	//default value
	private final int DEFAULT_INDICATOR_RADIUS = AdapterUtils.dp2px(getContext(),6);
	private final int DEFAULT_INDICATOR_MARGIN = AdapterUtils.dp2px(getContext(),10);
	...
	private void handleTypedArray(Context context,AttributeSet attrs) {
		...
		mIndicatorBackground = typedArray
				.getColor(R.styleable.CircleIndicator_ci_background,DEFAULT_INDICATOR_BACKGROUND);
		...
		int gravity = typedArray
				.getInt(R.styleable.CircleIndicator_ci_gravity,DEFAULT_INDICATOR_LAYOUT_GRAVITY);
	...
	private float startDrawPosition(final int containerWidth) {
		...
		float tabItemsLength = tabItems.size() * (2 * mIndicatorRadius + mIndicatorMargin)
		                       - mIndicatorMargin;
	...
	public void setIndicatorSelectedBackground(
			int mIndicatorSelectedBackground)
	{
