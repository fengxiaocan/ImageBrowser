...
public class InputDialog{
    ...
    public InputDialog(Context context){
        ...
        View view = LayoutInflater.from(context)
                                  .inflate(R.layout.layout_input_alert_view,
                                           null);
        // 获取自定义Dialog布局中的控件
        ...
        setRightButton("确定",new IDialogListener(){
            ...
            public void onClick(DialogInterface dialog){
                ...
                if(mInputResultListener != null){
                    mInputResultListener
                            .onResult(txt_input.getText().toString());
                }
            }
        });
        dialog.dismiss();
        ...
        txt_input.post(new Runnable(){
            ...
            public void run(){
                if(txt_input.getLineCount() > 4){
                    txt_input.setMaxWidth((int) context.getResources()
                                                       .getDimension(
     ...
     * @return the ios dialog
     */
    public InputDialog setMiddleButtonBackgroundResource(
     ...
     * @return the ios dialog
     */
    public InputDialog setOnKeyListener(
     ...
     * @return the ios dialog
     */
    public InputDialog setOnDismissListener(
