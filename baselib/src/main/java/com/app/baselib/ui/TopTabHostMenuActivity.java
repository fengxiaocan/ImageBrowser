...
/**
 * The type Top tab host menu activity.
 *
 * @项目名： BaseApp
 ...
 */
public abstract class TopTabHostMenuActivity extends AppActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (createContentView() != 0) {
            ...
            View view = View.inflate(this, R.layout.activity_tabhost_top, null);
            mMenuDrawer.setContentView(view);
        }
